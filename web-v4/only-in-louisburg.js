...
(function(){
  ...
  const fingerprints=[
    ...
    {icon:'📍',cat:'Stories',title:'Why It Is Called Louisburg',why:'The town was known as St. Louis, New St. Louis and Little St. Louis before railroad confusion helped drive the change to Louisburg.',url:'https://genealogytrails.com/kan/miami/books/cutler4.html'}
  ];
