...
(function(){
  ...
  const fingerprints=[
    ...
    {icon:'🏠',cat:'History',title:'The Little Round House',why:'A tiny Louisburg landmark that once served as a Kansas port-of-entry and inspection station before being restored at City Lake.',url:'https://www.miamicountyks.gov/684/Architecture'},
    ...
    {icon:'🎃',cat:'Seasonal',title:'Powell Pumpkin Patch',why:'A 35-acre pick-your-own pumpkin patch with a corn maze, free hayrides and a nature trail just outside town.',url:'https://powellpumpkinpatch.com/attractions/'},
    ...
    {icon:'🐅',cat:'Icons',title:'Cedar Cove Conservation Center',why:'A Louisburg nonprofit wildlife sanctuary and education center built around endangered big-cat conservation.',url:'https://www.cedarcoveconservationcenter.org/'},
    {icon:'🏛️',cat:'History',title:'Historic Broadway',why:'Louisburg’s old commercial spine still carries buildings and stories from the town’s railroad, theater, school, church, service-station and gathering-place eras.',url:'https://louisburgkansas.gov/222/Historic-Preservation-Commission'},
    ...
    {icon:'🛣️',cat:'History',title:'Frontier Military Scenic Byway',why:'US-69 along Louisburg follows the corridor of a military road built in the 1830s–1840s between frontier forts.',url:'https://www.travelks.com/things-to-do/byways-and-highways/byways/frontier-military/'},
    ...
    {icon:'🗞️',cat:'Stories',title:'Louisburg’s Newspaper Legacy',why:'The Louisburg Herald dates to 1876, leaving an unusually deep written record of local life and town history.',url:'https://www.ksgenweb.org/archives/1878/miami.html'},
    {icon:'📍',cat:'Stories',title:'Why It Is Called Louisburg',why:'The town was known as St. Louis, New St. Louis and Little St. Louis before railroad confusion helped drive the change to Louisburg.',url:'https://genealogytrails.com/kan/miami/history1.html'}
  ];
